...
function App(){
  ...
  if(!connected){
    return <div className="login-shell"><div className="glow glow-a"/><div className="glow glow-b"/>
      <section className="login-card">
        ...
        <label>URL do License Server<input value={baseUrl} onChange={e=>setBaseUrl(e.target.value)} placeholder="https://seu-worker.workers.dev" autoFocus /></label>
        <label>ADMIN_TOKEN<input type="password" value={token} onChange={e=>setToken(e.target.value)} placeholder="Bearer token administrativo" onKeyDown={e=>e.key==='Enter'&&connect()}/></label>
        ...
        <p className="security-note">Nenhuma credencial é salva no navegador. O ADMIN_TOKEN é enviado somente ao Worker para validar esta sessão.</p>
      </section>
    </div>
  }
